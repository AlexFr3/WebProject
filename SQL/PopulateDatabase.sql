...
((SELECT `idManga` FROM `Manga` WHERE `Titolo` = 'Hunter x Hunter'), (SELECT `idGenere` FROM `Genere` WHERE `Descrizione` = 'Azione')),
((SELECT `idManga` FROM `Manga` WHERE `Titolo` = 'Conan'), (SELECT `idGenere` FROM `Genere` WHERE `Descrizione` = 'Drammatico')),
((SELECT `idManga` FROM `Manga` WHERE `Titolo` = 'Minecraft'), (SELECT `idGenere` FROM `Genere` WHERE `Descrizione` = 'Fantasy'));
...
((SELECT `idManga` FROM `Manga` WHERE `Titolo` = 'Hunter x Hunter'), (SELECT `idCategoria` FROM `Categoria` WHERE `Descrizione` = 'Shonen')),
((SELECT `idManga` FROM `Manga` WHERE `Titolo` = 'Conan'), (SELECT `idCategoria` FROM `Categoria` WHERE `Descrizione` = 'Manga Italiani')),
((SELECT `idManga` FROM `Manga` WHERE `Titolo` = 'Minecraft'), (SELECT `idCategoria` FROM `Categoria` WHERE `Descrizione` = 'Shonen'));